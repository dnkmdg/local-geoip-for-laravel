...
return [
    'database_path' => env('LOCAL_GEOIP_DATABASE_PATH', storage_path('app/geoip/GeoLite2-City.mmdb')),
    ...
    'update' => [
        ...
        'edition_id' => env('LOCAL_GEOIP_UPDATE_EDITION_ID', env('LOCAL_GEOIP_EDITION_ID', 'GeoLite2-City')),
        'download_url' => env(
